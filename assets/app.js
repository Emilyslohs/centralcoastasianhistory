...
const inlineArticleImages = {
  ...
  "Helen Louis in 1939 [2]": {
    src: "assets/images/helen-louis-1939.avif",
    alt: "Helen Louis in 1939",
    className: "is-small-portrait",
    caption: "Helen Louis in 1939 [2]",
    hideText: true,
  },
  ...
  "San Luis Obispo High School Football Team [2]": {
    src: "assets/images/slo-high-football-team.avif",
    alt: "San Luis Obispo High School Football Team",
    className: "is-small-wide",
    caption: "San Luis Obispo High School Football Team [2]",
    hideText: true,
  },
  "Letter of Recommendation from H. L. Kemper to Commissioner of Immigration and Naturalization [2]": {
    src: "assets/images/kemper-recommendation-letter.avif",
    alt: "Letter of Recommendation from H. L. Kemper to Commissioner of Immigration and Naturalization",
    className: "is-small-wide",
    caption: "Letter of Recommendation from H. L. Kemper to Commissioner of Immigration and Naturalization [2]",
    hideText: true,
  },
